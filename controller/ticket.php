    ...
    switch($_GET["op"]){
        ...
        case "listar_x_usu":
            ...
            foreach($datos as $row) {
                ...
                $sub_array[] = '<button type="button" onClick="ver('.$row["tick_id"].');" id="'.$row['tick_id'].'" class="btn btn-inline btn-primary btn-sm ladda-buttom"><div><i class="fa fa-eye"></i></div></button>';
                $data[] = $sub_array;
            }
            $results = array(
                "sEcho"=>1,
                                ...
                                <header class="activity-line-item-header">
                                    <div class="activity-line-item-user">
                                        <div class="activity-line-item-user-photo">
                                            <a href="#">
                                                <img src="../../public/<?php echo $row["rol_id"]?>.svg" alt="">
                                            </a>
                                        </div>
        ...
        case "mostrar":
            ...
            if(is_array($datos) == true and count($datos)>0){
                foreach($datos as $row) {
                    ...
                    if( $row["tick_estado"] == "Abierto"){
                        $output["tick_estado"] = '<div class="label label-pill label-success">Abierto</span>';
                    }else{
                        $output["tick_estado"] = '<div class="label label-pill label-danger">Cerrado</div>';
                    }
