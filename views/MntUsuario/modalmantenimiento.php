            ...
            <form method="post" id="usuario_form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="usu_correo" name="usu_correo" placeholder="ejemplo@ejemplo.com" required>       
                    </div>  
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="action" id="#" value="add" class="btn btn-rounded btn-primary">Guarda</button>
                </div>
            </form>
        </div>
    </div>
